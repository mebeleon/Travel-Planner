...
public class BFSTest {
    ...
    public void testBFS() {
        ...
        travelController.load("data/cities1", "data/transport1");
        System.out.println(travelController.getGraph().getVertices());
        System.out.println(travelController.mostDirectRoute("New York City", "Providence"));
    }
}
